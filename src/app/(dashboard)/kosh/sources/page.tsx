...
import { TreasurySummaryCard } from "@/components/cards/TreasurySummaryCard";
import { TreasuryMaturityBar } from "@/components/cards/TreasuryMaturityBar";
        ...
        <div className="flex flex-col min-h-screen p-6 pb-24 relative">
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <PageGuide
                    ...
                    actions={[{ emoji: "ðŸ’°", label: "Add income" }, { emoji: "ðŸ“Š", label: "Analytics" }, { emoji: "ðŸ§®", label: "Disposable" }]}
                />
                <div className="h-4" />
                ...
                {records.length === 0 ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center py-16">
                        ...
                        <div className="mt-6 w-full">
                            ...
                            <VideoTutorialPlaceholder youtubeId="iWsQY6Ha4OE" label="Smart budgeting for Indians â€” income, expenses & savings" />
                        </div>
                    </div>
                ) : (
                    <>
                        ...
                        <div className="mt-4 bg-white/3 border border-white/8 rounded-xl p-3.5 space-y-1.5">
                            ...
                            {insights.map((insight, i) => (
                                <p key={i} className="text-xs text-white/50">â€¢ {insight}</p>
                            ))}
                        </div>
