        ...
        <div className="flex flex-col min-h-screen p-6 pb-24 relative">
            ...
            <div className="relative z-10">
                ...
                <PageGuide
                    ...
                    actions={[{ emoji: "ðŸ’§", label: "Track drains" }, { emoji: "ðŸº", label: "Fill the Matka" }]}
                />
                <div className="h-3" />
                ...
                <div className="bg-[var(--color-rajya-card)] border border-[var(--color-rajya-accent)]/20 rounded-2xl p-5 mb-5">
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex-1 space-y-2">
                            <div className="flex justify-between text-xs">
                                ...
                                <span className="text-white/70">{monthlyIncome > 0 ? formatRupee(monthlyIncome) : "â€”"}</span>
                            </div>
                            <div className="flex justify-between text-xs">
                    ...
                    {ratio ? (
                        ...
                        <div className="mt-3 flex items-center gap-2">
                            <p className="text-xs text-white/40">Expense-to-Income: â€”</p>
                ...
                {insights.length > 0 && (
                    <div className="bg-white/3 border border-white/8 rounded-xl p-3 mb-4 space-y-1">
                        ...
                        {insights.map((ins, i) => (
                            <p key={i} className="text-xs text-white/50">â€¢ {ins}</p>
                        ))}
                    </div>
                )}
                ...
                {subTotal > 0 && (
                    <div className="bg-white/3 border border-white/8 rounded-xl p-3 mb-4 flex justify-between items-center">
                        <span className="text-xs text-white/40">ðŸ“¦ Subscriptions</span>
