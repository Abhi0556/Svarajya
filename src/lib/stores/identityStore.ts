// Module 2: Identity Store â€” in-memory data layer for identity documents, contacts, and links.
...
export interface IdentityDoc {
    ...
    // Stage 2 (deep mode) fields â€” all optional
    dobOnDoc?: string;
    expiryDate?: string;
    issueDate?: string;
    placeOfIssue?: string;
...
// â€”â€”â€”â€”â€”â€”â€” Normalize â€”â€”â€”â€”â€”â€”â€”
...
// â€”â€”â€”â€”â€”â€”â€” Seal Strength â€”â€”â€”â€”â€”â€”â€”
// For linkable docs (Aadhaar/PAN/Passport): 5 dimensions Ã— 20 = 100
// For non-linkable docs (DL/Voter/Other): 4 dimensions Ã— 25 = 100 (no link penalty)
...
export const IdentityStore = {
    ...
    addDoc(partial: Omit<IdentityDoc, "id" | "normalizedDocNumber" | "createdAt" | "updatedAt" | "verificationStatus" | "storageMode">): IdentityDoc {
        ...
        // Sync to API â€” omit client-generated id so API creates new record
    ...
    // â€”â€”â€” Identity Confidence â€”â€”â€”
    ...
    // â€”â€”â€” Seed from onboarding â€”â€”â€”
    seedFromOnboarding() {
        const data = OnboardingStore.get();
        // Only seed once â€” check if contacts already exist from onboarding
